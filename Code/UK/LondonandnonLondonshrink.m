...
h = 0.20;                                                                  %医院内的空床位比例 the proportion of empty beds in hospital
...
for idx = 1:length(T)-1
    ...
    elseif idx >= 46                                                       %以二月七日为起准，46日后即三月二十三日进行混合限制流通措施 from February 7, restrictions was imposed for 46 days
...
% plot(T(9:349),Rt2(9:349));grid on;hold on;
